...
class ReadGenre : AppCompatActivity() {
    ...
    */
    ...
    just like retrieves all books in Read bookshelf.
    */
    ...
    /*
    Retrieves all books in End-user Read bookshelf
    */
            ...
            override fun onResponse(
                ...
                if (response.code() == 200) {
                    ...
                    if (categoryList.size <= 1) {
                        runOnUiThread {
                            layout.adapter = CategoryAdapter(categoryList, "4")
                        }
                    }
                    ...
                    // items that have been repeated.
                        ...
                        runOnUiThread {
                            ...
                            layout.adapter = CategoryAdapter(newCategoryList, "4")
                        }
                    }
